...
var listCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		categories, err := sdkclient.FetchAll(ctx, func(ctx context.Context, page, perPage int) ([]ecommerce.Category, bool, error) {
			path := fmt.Sprintf("/shops/%s/categories?page=%d&limit=%d", shopID, page, perPage)
...
var getCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ctx := context.Background()
		path := fmt.Sprintf("/shops/%s/categories/%s", shopID, args[0])
...
var createCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ctx := context.Background()
		path := fmt.Sprintf("/shops/%s/categories", shopID)
		var result ecommerce.RootCategory
...
var countCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ctx := context.Background()
		path := fmt.Sprintf("/shops/%s/categories?limit=0", shopID)
...
var productsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ctx := context.Background()
		path := fmt.Sprintf("/shops/%s/categories/%s/products", shopID, args[0])
...
var unassignProductCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ctx := context.Background()
		path := fmt.Sprintf("/shops/%s/categories/%s/products/%s", shopID, args[0], productID)
		_, err = sdkclient.DoRaw(ctx, httpClient, apiKey, http.MethodDelete, path, nil, nil)
		if err != nil {
			return err
		}
